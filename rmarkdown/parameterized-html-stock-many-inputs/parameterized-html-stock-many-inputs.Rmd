...
The current forecast for `r params$forecast` is __$`r round(as.numeric(f$mean)[1],2)`__ per share.
...
```{r, warning=FALSE, message=FALSE}
subject <- paste0("GOOG forecast for ,", params$forecast, ": $", round(as.numeric(f$mean)[1],2), " (", Sys.time(), ")")
